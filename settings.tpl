<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
    ...
    <form method = POST action="index.php?main_page=settings">
      <input type="hidden" name="post_action" value="change_settings">
      <div class="input-group">
        <textarea class="form-control font-weight-bold" rows = 50 aria-label="With textarea" name = "text_settings">{$settings}</textarea>
      </div>
      <br>
    <input type="reset">
    <input type="submit">
